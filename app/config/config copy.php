<?php
define('DEFAULT_TITLE', 'Formulario de Ingrerso - Tacticas Panamá');// titulo general para toda la pagina
...
$config ['production']['db']['name'] ='form_nomina';
$config ['production']['db']['user'] ='form_nomina';
...
$config ['development']['db']['name'] ='formulario_tacticas';
