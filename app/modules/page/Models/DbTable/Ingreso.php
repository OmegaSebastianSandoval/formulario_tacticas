...
class Page_Model_DbTable_Ingreso extends Db_Table
{
	...
	public function insert($data)
	{
		...
		$ingreso_empresa = $data['ingreso_empresa'];
		$ingreso_cargo = $data['ingreso_cargo'];
		$ingreso_talla_sueter = $data['ingreso_talla_sueter'];
		$ingreso_talla_pantalon = $data['ingreso_talla_pantalon'];
		$ingreso_talla_calzado = $data['ingreso_talla_calzado'];
		$query = "INSERT INTO ingreso( ingreso_fecha_ingreso, ingreso_nombre, ingreso_apellido, ingreso_fecha_nacimiento, ingreso_lugar_nacimiento, ingreso_cedula, ingreso_nacionalidad, ingreso_direccion_casa, ingreso_telefono, ingreso_telefono_casa, ingreso_email, ingreso_estado_civil, ingreso_nombre_pareja, ingreso_carnet_blanco, ingreso_numero_hijos, ingreso_numero_seguro_social, ingreso_hobby, ingreso_edad, ingreso_sexo, ingreso_carnet_verde, ingreso_afiliado_seguro_social, ingreso_nombre_madre, ingreso_telefono_madre, ingreso_nombre_padre, ingreso_telefono_padre, ingreso_vive_casa, ingreso_fecha_solicitud, ingreso_estado_solicitud, ingreso_empresa, ingreso_cargo, ingreso_talla_sueter, ingreso_talla_pantalon, ingreso_talla_calzado ) VALUES ( '$ingreso_fecha_ingreso', '$ingreso_nombre','$ingreso_apellido', '$ingreso_fecha_nacimiento', '$ingreso_lugar_nacimiento', '$ingreso_cedula', '$ingreso_nacionalidad', '$ingreso_direccion_casa', '$ingreso_telefono', '$ingreso_telefono_casa', '$ingreso_email', '$ingreso_estado_civil', '$ingreso_nombre_pareja', '$ingreso_carnet_blanco', '$ingreso_numero_hijos', '$ingreso_numero_seguro_social', '$ingreso_hobby', '$ingreso_edad', '$ingreso_sexo', '$ingreso_carnet_verde', '$ingreso_afiliado_seguro_social', '$ingreso_nombre_madre', '$ingreso_telefono_madre', '$ingreso_nombre_padre', '$ingreso_telefono_padre', '$ingreso_vive_casa', '$ingreso_fecha_solicitud', '$ingreso_estado_solicitud', '$ingreso_empresa', '$ingreso_cargo', '$ingreso_talla_sueter', '$ingreso_talla_pantalon', '$ingreso_talla_calzado')";
