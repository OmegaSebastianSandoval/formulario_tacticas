...
<div class="container-fluid">
	<form action="<?php echo $this->route; ?>" method="post">
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            <label>datos_academicos_formacion</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-rojo-claro " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="datos_academicos_formacion" value="<?php echo $this->getObjectVariable($this->filters, 'datos_academicos_formacion') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>datos_academicos_cedula_colaborador</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono fondo-azul " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="datos_academicos_cedula_colaborador" value="<?php echo $this->getObjectVariable($this->filters, 'datos_academicos_cedula_colaborador') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			<thead>
				<tr>
					<td>datos_academicos_formacion</td>
					<td>datos_academicos_cedula_colaborador</td>
					<td width="100"></td>
				</tr>
			</thead>
			<tbody>
				<?php foreach($this->lists as $content){ ?>
				<?php $id =  $content->datos_academicos_id; ?>
					<tr>
						<td><?=$content->datos_academicos_formacion;?></td>
						<td><?=$content->datos_academicos_cedula_colaborador;?></td>
						<td class="text-right">
							<div>
